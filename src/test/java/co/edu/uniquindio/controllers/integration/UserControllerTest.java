...
public class UserControllerTest {
    ...
    void testCreateUserValueConflictExceptionWhenEmailExists() throws Exception {
        ...
        GeoJsonPoint location = new GeoJsonPoint(-75.6801, 4.5350);
        var user = new UserRegistrationRequest("123",userStore.getEmail(),"Aa12345*","Juan Galvis",LocalDate.of(1980,6,25),"2121","Calle 9","Armenia",location,Role.CLIENT);
    ...
    void testGetUserSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/users/"+userStore.getId()))
                ...
                .andExpect(jsonPath("$.fullName").value(userStore.getName()))
